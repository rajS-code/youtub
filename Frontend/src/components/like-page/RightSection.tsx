...
import LikedCategoryTab from './LikedCategoryTab'
import Link from 'next/link'
import { ArrowDownToLine, Bookmark, Clock, ListStart, MoreVertical, Trash2 } from 'lucide-react';
import { Button } from '../ui/button';
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from '../ui/dropdown-menu';

const RightSection = ({ likedVideos } : { likedVideos: any[] }) => {
  return (
    <div className="p-5">
      <LikedCategoryTab />
      <div className="mt-4">
